...
public class XAttributeImpl extends XElementImpl implements XAttribute
{
  ...
  public NotificationChain basicSetXtype(XTypeRef newXtype, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XhdlPackage.XATTRIBUTE__XTYPE, oldXtype, newXtype);
  ...
  public void setXtype(XTypeRef newXtype)
  {
    if (newXtype != xtype)
    {
      ...
      if (xtype != null)
        msgs = ((InternalEObject)xtype).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XhdlPackage.XATTRIBUTE__XTYPE, null, msgs);
      if (newXtype != null)
        msgs = ((InternalEObject)newXtype).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XhdlPackage.XATTRIBUTE__XTYPE, null, msgs);
      msgs = basicSetXtype(newXtype, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XhdlPackage.XATTRIBUTE__XTYPE, newXtype, newXtype));
  }

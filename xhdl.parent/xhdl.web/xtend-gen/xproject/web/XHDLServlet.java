...
import xproject.web.XHDLWebSetup;
...
public class XHDLServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new XHDLWebSetup().createInjectorAndDoEMFRegistration();

...
<f:view>
    <html>
        <head>
            ...
            <title>Editing AdditionalPerformers</title>
        ...
        <body>
            ...
            <h1>Editing AdditionalPerformers</h1>
            <h:form>
                ...
                <br />
                <h:commandLink action="#{additionalPerformers.edit}" value="Save">
                ...
                <br />
                <br />
                <h:commandLink action="#{additionalPerformers.detailSetup}" value="Show" immediate="true">
                    <f:param name="jsfcrud.currentAdditionalPerformers" value="#{jsfcrud_class['com.kdq.open_up.jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][additionalPerformers.additionalPerformers][additionalPerformers.converter].jsfcrud_invoke}"/>
                </h:commandLink>
                <br />

 ...
 */
@Embeddable
public class InputsPK implements Serializable {
    ...
    public InputsPK(String task, String artifact) {
        this.task = task;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InputsPK)) {
            return false;
        }
        InputsPK other = (InputsPK) object;
    ...
    public String toString() {
        return "com.kdq.open_up.InputsPK[ task=" + task + ", artifact=" + artifact + " ]";
    }
